 ...
 * descriptor is documented in section 9.6.3 of the USB 3.0 specification.<br>
 * All multiple-byte fields are represented in host-endian format.<br>
 * <i>native declaration : include\libusb.h:728</i><br>
...
public class libusb_config_descriptor extends Structure {
	...
	public org.jayhsu.libuvc4java.jna.libusb_interface.ByReference interface$;
	...
	protected List<? > getFieldOrder() {
		return Arrays.asList("bLength", "bDescriptorType", "wTotalLength", "bNumInterfaces", "bConfigurationValue", "iConfiguration", "bmAttributes", "MaxPower", "interface$", "extra", "extra_length");
	}
	public libusb_config_descriptor(Pointer peer) {
		super(peer);
	}
