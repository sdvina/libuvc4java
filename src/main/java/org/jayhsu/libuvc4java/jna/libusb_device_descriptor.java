 ...
 * descriptor is documented in section 9.6.1 of the USB 3.0 specification.<br>
 * All multiple-byte fields are represented in host-endian format.<br>
 * <i>native declaration : include\libusb.h:504</i><br>
...
public class libusb_device_descriptor extends Structure {
	...
	public libusb_device_descriptor(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends libusb_device_descriptor implements Structure.ByReference {
		
	};
	public static class ByValue extends libusb_device_descriptor implements Structure.ByValue {
